...
public partial class wuc_master_wucAyudaVideo : System.Web.UI.UserControl
{
    ...
    protected void lbnAyudaVideo_Click(object sender, EventArgs e)
    {
        int? ItemId = null;
        ...
        try
        {
            ...
            this.lblAyudaVideoTitulo.Text = lstMenu[0].Descripcion;
            this.UrlAyudaVideo = lstMenu[0].Url_Ayuda_Video;
        }
        catch
        {
            //this.UrlAyudaManual = "";
            this.lblAyudaVideoTitulo.Text = "";
            this.UrlAyudaVideo = "";
        }


        this.litAyudaVideoTexto.Text = String.Format("<iframe width='100%' height='450px' src='{0}' style='border: none;'></iframe>"
                                                        , this.UrlAyudaVideo
                                                        );

        this.pnlAyudaVideo.CssClass = "modal-dialog modal-form";
        this.mdlAyudaVideo.Show();
    }
}