<%@   Page Title="Tabla que almacena las diferentes entidades que emiten fianzas o cheques." Language="C#" MasterPageFile="~/master_ajax.master" AutoEventWireup="true" CodeFile="wf_Emisores.aspx.cs" Inherits="wf_Emisores"%>
		...
		<div class="widget-body">
			<div class="form-horizontal widget-main" role="form">
				<div class="form-group hidden">
					<asp:Label ID="lbl_IdEmisor" runat="server" AssociatedControlID="nb_IdEmisor" CssClass="col-xs-2 control-label">IdEmisor:</asp:Label>
					<div class="col-xs-10">
						<ew:NumericBox ID="nb_IdEmisor" runat="server" SkinID="skin_entero" Width="50px"></ew:NumericBox>
					</div>
				</div>
						<asp:RequiredFieldValidator ID="rfv_IdEmisor" runat="server" ErrorMessage="El campo IdEmisor es requerido." ForeColor="Red" ControlToValidate="nb_IdEmisor" ValidationGroup="vg_guardar" Display="Dynamic" InitialValue="0"></asp:RequiredFieldValidator>
		...
		<div class="widget-body">
			<div class="widget-main">
				<asp:GridView ID="gv_Datos" runat="server" Width="100%" SkinID="skin_grilla_sin_paginacion"
					PageSize="10" AllowPaging="True" DataKeyNames="IdEmisor"
