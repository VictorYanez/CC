<%@ Page Title="" Language="C#" MasterPageFile="~/master_ajax.master" AutoEventWireup="true" CodeFile="wf_GarantiasPorDevolver.aspx.cs" Inherits="sistema_gfi_wf_GarantiasPorDevolver" %>
											...
											<div class="widget-main">
											   <div class="row">
                                                   <div class="col-xs-2">
                                                         ...
                                                         <ajax:ConfirmButtonExtender ID="cbe_CambiarEstado" runat="server" TargetControlID="lb_CambiarEstado" ConfirmText="¿Confirma que desea cambiar de estado todas las garantias seleccionadas?. Al confirmar las garantias pasarán a estado en DEVUELTA por parte de la GFI."></ajax:ConfirmButtonExtender>
                                                      &nbsp;
                                                   </div>
                                                   <div class="col-xs-5">
