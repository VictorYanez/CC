<%@   Page Title="Tabla que almacena los diferentes tipos de concesionarios." Language="C#" MasterPageFile="~/master_ajax.master" AutoEventWireup="true" CodeFile="wf_Tiposconcesionarios.aspx.cs" Inherits="wf_Tiposconcesionarios"%>
...
<asp:Content ID="cContenido" ContentPlaceHolderID="cphContenido" runat="Server">
	<div id="div_wuc" runat="server">
		<wuc:uc_mantenimiento
			...
			OnGuardar="Guardar" OnCancelar="Cancelar" MostrarBuscarPersonalizado="false"
		...
		<div class="widget-body">
			<div class="form-horizontal widget-main" role="form">
				<div class="form-group hidden">
					<asp:Label ID="lbl_IdTipoConcesionario" runat="server" AssociatedControlID="nb_IdTipoConcesionario" CssClass="col-xs-2 control-label">IdTipoConcesionario:</asp:Label>
					<div class="col-xs-10">
						<ew:NumericBox ID="nb_IdTipoConcesionario" runat="server" SkinID="skin_entero" Width="50px"></ew:NumericBox>
					</div>
				</div>
						<asp:RequiredFieldValidator ID="rfv_IdTipoConcesionario" runat="server" ErrorMessage="El campo IdTipoConcesionario es requerido." ForeColor="Red" ControlToValidate="nb_IdTipoConcesionario" ValidationGroup="vg_guardar" Display="Dynamic" InitialValue="0"></asp:RequiredFieldValidator>
		...
		<div class="widget-body">
			<div class="widget-main">
				<asp:GridView ID="gv_Datos" runat="server" Width="100%" SkinID="skin_grilla_sin_paginacion"
					PageSize="10" AllowPaging="True" DataKeyNames="IdTipoConcesionario"
