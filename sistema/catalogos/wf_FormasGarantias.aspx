<%@   Page Title="Tabla que almacena la forma en la que se emite la garantía." Language="C#" MasterPageFile="~/master_ajax.master" AutoEventWireup="true" CodeFile="wf_Formasgarantias.aspx.cs" Inherits="wf_Formasgarantias"%>
		...
		<div class="widget-body">
			<div class="form-horizontal widget-main" role="form">
				<div class="form-group hidden">
					<asp:Label ID="lbl_IdForma" runat="server" AssociatedControlID="nb_IdForma" CssClass="col-xs-2 control-label">IdForma:</asp:Label>
					<div class="col-xs-10">
						<ew:NumericBox ID="nb_IdForma" runat="server" SkinID="skin_entero" Width="50px"></ew:NumericBox>
					</div>
				</div>
						<asp:RequiredFieldValidator ID="rfv_IdForma" runat="server" ErrorMessage="El campo IdForma es requerido." ForeColor="Red" ControlToValidate="nb_IdForma" ValidationGroup="vg_guardar" Display="Dynamic" InitialValue="0"></asp:RequiredFieldValidator>
				<div class="form-group">
					<asp:Label ID="lbl_Nombre" runat="server" AssociatedControlID="txt_Nombre" CssClass="col-xs-2 control-label">Nombre:</asp:Label>
					<div class="col-xs-10">
						<asp:TextBox Id="txt_Nombre" runat="server" CssClass="form-control" MaxLength="20"></asp:TextBox>
		...
		<div class="widget-body">
			<div class="widget-main">
				<asp:GridView ID="gv_Datos" runat="server" Width="100%" SkinID="skin_grilla_sin_paginacion"
					PageSize="10" AllowPaging="True" DataKeyNames="IdForma"
